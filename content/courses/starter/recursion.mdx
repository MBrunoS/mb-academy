---
title: Recursão
description: "Descubra o que é recursão e como usar funções que chamam a si mesmas para resolver problemas de forma elegante."
---
...
1.  Crie uma função `fibonacci(n)`.
2.  Defina os **casos base**:
    *   Se `n` for 0, retorne 0.
    *   Se `n` for 1, retorne 1.
3.  Para qualquer outro `n`, a função deve retornar a soma de `fibonacci(n - 1)` e `fibonacci(n - 2)`.
