...
3. **Integrar IA em código** — construir uma extensão do seu Rastreador de Gastos que se comunica com uma API de IA para gerar análises financeiras personalizadas.
