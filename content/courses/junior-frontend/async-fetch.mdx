...
E uma API fictícia que responde em `https://api.mbacademy.dev/gastos/:id`, devolvendo um JSON no formato:
...
2. Ao clicar no botão, leia o valor digitado em `#input-id` e faça uma requisição `fetch` para `https://api.mbacademy.dev/gastos/{id}`.
