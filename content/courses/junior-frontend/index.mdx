...
Ver o mesmo problema resolvido de formas cada vez mais sofisticadas — CLI, DOM manual, componentes React, aplicação autenticada e integração por contrato — é uma das melhores formas de sentir o quanto você evoluiu. Se uma sprint anterior bloquear você, baixe o pacote `sprint-N-materials` correspondente para retomar do zero; a solução de referência fica separada, em `reference-solution/`, para consulta posterior.
