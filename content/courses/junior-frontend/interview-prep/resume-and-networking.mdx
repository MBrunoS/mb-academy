...
> "Desenvolvi o MB Finanças em React e TypeScript, com autenticação, CRUD de receitas e despesas, filtros, paginação e integração baseada em OpenAPI. Testei regras, componentes e falhas de rede, publiquei um modo demonstração e validei o mesmo cliente contra uma API HTTP real."
