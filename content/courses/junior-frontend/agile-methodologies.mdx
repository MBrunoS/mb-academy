...
Você já viu como deixar seu código mais fácil de manter e como pensar visualmente em uma interface. Falta uma peça igualmente importante da rotina de um front-end júnior, mas que não tem nada a ver com código: como o trabalho em si é organizado dentro de um time.
